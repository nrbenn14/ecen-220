...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab04/proj/proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourFunctions.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourFunctions.tcl
