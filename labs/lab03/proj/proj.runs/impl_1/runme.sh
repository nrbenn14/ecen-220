...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab04/proj/proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FourFunctions.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FourFunctions.tcl -notrace
