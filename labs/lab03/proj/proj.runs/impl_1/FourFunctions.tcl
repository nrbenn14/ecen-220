...
set rc [catch {
  ...
  open_checkpoint FourFunctions_routed.dcp
  set_property webtalk.parent_dir /auto/fsi/nrbenn14/ECEn_220/labs/lab04/proj/proj.cache/wt [current_project]
  catch { write_mem_info -force FourFunctions.mmi }
  write_bitstream -force FourFunctions.bit 
  catch {write_debug_probes -quiet -force FourFunctions}
  catch {file copy -force FourFunctions.ltx debug_nets.ltx}
