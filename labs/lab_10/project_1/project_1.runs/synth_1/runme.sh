...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab_10/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_top.tcl
