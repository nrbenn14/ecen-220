...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab_10/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rx_top.tcl -notrace
