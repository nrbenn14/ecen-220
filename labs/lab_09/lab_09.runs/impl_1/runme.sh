...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab_09/lab_09.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codebreaker_serial_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codebreaker_serial_top.tcl -notrace
