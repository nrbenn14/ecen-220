...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab_09/lab_09.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codebreaker_serial_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codebreaker_serial_top.tcl
