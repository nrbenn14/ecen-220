...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/12lab_good/12lab_good.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pong.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_pong.tcl -notrace
