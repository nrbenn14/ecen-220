...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab_11/lab_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_object_drawer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_object_drawer.tcl
