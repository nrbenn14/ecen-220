...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab_11/lab_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_object_drawer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_object_drawer.tcl -notrace
