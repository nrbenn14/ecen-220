...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab06_2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_segment_top.tcl
