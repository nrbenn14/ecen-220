...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab06_2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_segment_top.tcl -notrace
