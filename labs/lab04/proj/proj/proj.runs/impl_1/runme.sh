...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab05/proj/proj/proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arithmetic_top.tcl -notrace
