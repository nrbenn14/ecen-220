...
set rc [catch {
  ...
  open_checkpoint arithmetic_top_routed.dcp
  set_property webtalk.parent_dir /auto/fsi/nrbenn14/ECEn_220/labs/lab05/proj/proj/proj.cache/wt [current_project]
  catch { write_mem_info -force arithmetic_top.mmi }
  write_bitstream -force arithmetic_top.bit 
  catch {write_debug_probes -quiet -force arithmetic_top}
  catch {file copy -force arithmetic_top.ltx debug_nets.ltx}
