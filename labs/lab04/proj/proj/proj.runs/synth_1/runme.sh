...
HD_PWD='/auto/fsi/nrbenn14/ECEn_220/labs/lab05/proj/proj/proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arithmetic_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arithmetic_top.tcl
